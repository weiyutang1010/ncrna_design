...
while IFS= read -r line; do
    ...
    # example: default softmax mode
    # echo "${puzzles[1]}" | ./main --step 1000 > results/$2/${puzzles[0]}.txt

    # example_2: projection
    echo "${puzzles[1]}" | ./main --step 1000 --projection --init targeted --eps 1.0 --lr 0.01 --lr_decay --adaptive_lr --lr_decay_rate 0.5 > results/$2/${puzzles[0]}.txt
done < "data/$1"
